#!/bin/bash
#######################6. github #####################6. github ######################6. github #####################6. github && gh#####################6. github && gh gh######################6. github #####################6. github && gh#####################6. github && gh gh gh#####################6. github ######################6. github #####################6. github && gh#####################6. github && gh gh######################6. github #####################6. github && gh#####################6. github && gh gh gh gh
