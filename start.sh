...
[[ ! -f $HOME/tmp/Terminus.zip ]] && [[ ! -d $HOME/tmp/Terminus ]] && wget https://github.com/ryanoasis/nerd-fonts/releases/download/v3.2.1/Terminus.zip && unzip Terminus.zip && sudo mv *.ttf /usr/share/fonts 
#echo user1
