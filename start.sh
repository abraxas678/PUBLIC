...
brew() {
  /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)" && echo 'eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)"' >> ~/.zprofile && eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)"
}
echo; echo "BREW"
brew
